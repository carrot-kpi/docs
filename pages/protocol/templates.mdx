...
*: **when we mention
upgrades, we mean for future uses of a certain template. Template instances that
have already been deployed and are in use are always trustless and immutable in
Carrot.**
