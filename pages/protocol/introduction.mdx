...
<Subtitle>
    Get started with Carrot and what it's all about.
</Subtitle>
...
-   **Condition**: the goal needs to be turned to a condition so that Carrot can
    correctly asses if it was reached or not. This is a simple step that will be
    described in more details later in the documentation.
...
-   **KPI tokens**: KPI tokens essentially represent a claim to all or part of
    the collateral in case the goal is partially or fully reached.
...
templates, the use of which enables Carrot to be extremely flexible in
implementing incentivization strategies that work great for every possible use
case. The concept of templates is greatly expaneded in the next section.
