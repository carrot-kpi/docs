...
In particulat the shown information includes:
...
The possible states and values shown in this sections are:
...
-   **Finalized without balance**: if the KPI token has finalized but the
...
control over this, it jsut allocates part of the page to render the oracle's
