...
-   **Direct oracle link**: if for any reason the Carrot oracle page is not
    ...
    is offered to increase the availability of the oracle. The link can also be
    used to double check that all the shown parameters are correct.
...
-   **Bonded amount**: this is the native currency amount that has been bonded
    ...
    native currency will need to paid in order to override the answer.
...
possibly double to override it, they can request arbitration.
